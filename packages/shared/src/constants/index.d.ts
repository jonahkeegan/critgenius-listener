...
export declare const UPLOAD_LIMITS: {
    ...
    readonly ALLOWED_EXTENSIONS: readonly [".wav", ".mp3", ".m4a", ".ogg", ".flac", ".webm"];
    readonly ALLOWED_MIME_TYPES: readonly ["audio/wav", "audio/wave", "audio/x-wav", "audio/mpeg", "audio/mp3", "audio/mp4", "audio/m4a", "audio/ogg", "audio/webm", "audio/flac"];
};
/**
...
export declare const SERVER_CONFIG: {
    ...
    readonly CORS_ORIGINS: readonly ["http://localhost:3000", "http://localhost:5173", "http://127.0.0.1:3000", "http://127.0.0.1:5173"];
};
/**
